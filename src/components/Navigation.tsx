          ...
          >
            <div className="flex flex-col space-y-4">
              ...
              <a
                ...
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white glow hover:scale-105 transition-transform"
              >
              ...
              <a
                ...
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 text-white glow hover:scale-105 transition-transform"
              >
                <Phone size={20} />
                Call Us
              </a>
              <a
                href="#contact"
                onClick={() => setIsMobileMenuOpen(false)}
                className="px-6 py-2 rounded-full bg-gradient-to-r from-primary to-accent text-white text-center glow"
              >
                Book Now
              </a>
            </div>
